...
Generated: 2026-06-15T08:54:31.252Z
...
│   │   │   │   └── → connectors
│   │   │   ├── dreamdmbar.ts
│   │   │   │   ├── (dynamic)  ← @/dreamdmbar/barInteractions
│   │   │   │   ├── (dynamic)  ← @/dreamdmbar/bridgeSeamFlow
│   │   │   │   ├── (dynamic)  ← @/dreamdmbar/dream.GlowingLight
│   │   │   │   ├── (dynamic)  ← @/dreamdmbar/dreamsurface.dreamdmbar
│   │   │   │   ├── (dynamic)  ← @/dreamdmbar/DreamSystemContext
│   │   │   │   ├── (dynamic)  ← @/dreamdmbar/useDreamBarContext
│   │   │   │   ├── (dynamic)  ← @/dreamdmbar/useDreamDMConversations
│   │   │   │   ├── (dynamic)  ← @/dreamdmbar/useDreamDMDraft
│   │   │   │   ├── (dynamic)  ← @/dreamdmbar/useDreamDMMessages
│   │   │   │   ├── (dynamic)  ← @/dreamdmbar/useDreamSearch
│   │   │   │   ├── (dynamic)  ← @/dreamdmbar/useMessagingCore
│   │   │   │   ├── (dynamic)  ← @/dreamdmbar/useModuleBarIntent
│   │   │   │   ├── (dynamic)  ← @/dreamdmbar/useNotifications
│   │   │   │   └── → dreamdmbar
│   │   │   ├── dreamr.ts
