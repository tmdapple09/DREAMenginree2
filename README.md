...
This repository currently exposes about 112 app pages, 125 API route files, and 366 files under `engins/`, with `ARCHITECTURE.md` treated as the project authority for system meaning.
...
### Repo Evidence
Matched focused repo evidence: 80 files, about 34,316 readable source lines.

Behavior signals:
- auth — 49 file hits
- commerce — 42 file hits
...
- `app/edit-profiledream/page.tsx` — 603 lines — score 116 — primary path
...
- `eslint.config.mjs` — 104 lines — score 112 — primary path
...
- `engins/renderengin/RenderEnginViewport.tsx` — 445 lines — score 104 — primary path
- `components/runtime/dream.RuntimeView.tsx` — 432 lines — score 104 — primary path
- `components/runtime/dream.DualRuntimeContainer.tsx` — 272 lines — score 104 — primary path
...
- `engins/contentengin/ImplicitAssetWorkspace.tsx` — 87 lines — score 104 — primary path
...
- `styles/globals.css` — 5174 lines — score 100 — primary path
...
### Repo Evidence
Matched focused repo evidence: 110 files, about 45,601 readable source lines.

Behavior signals:
- auth — 72 file hits
- persistence — 60 file hits
- commerce — 54 file hits
- state — 52 file hits
...
### Repo Evidence
Matched focused repo evidence: 26 files, about 7,117 readable source lines.
...
- useEffect — components/runtime/dream.DualRuntimeContainer.tsx
...
- DualRuntimeChannel — engine/runtime/dualRuntimeBridge.ts
...
- `engine/runtime/dualRuntimeBridge.ts` — 916 lines — score 112 — primary path
- `components/runtime/dream.DualRuntimeContainer.tsx` — 272 lines — score 112 — primary path
...
- `engine/runtime/dreamOSBus.ts` — 835 lines — score 63 — supporting path
...
### Repo Evidence
Matched focused repo evidence: 55 files, about 15,151 readable source lines.
...
- `dreamr/feed/useLiveFeed.ts` — 320 lines — score 160 — primary path, path keyword: dreamr
...
- `components/dream.HomeFeed.tsx` — 1378 lines — score 67 — supporting path
- `app/edit-profiledream/page.tsx` — 603 lines — score 67 — supporting path
- `components/dream.FeedCard.tsx` — 474 lines — score 63 — supporting path
## 9. The Shop
...
### Repo Evidence
Matched focused repo evidence: 5 files, about 844 readable source lines.
...
- useEffect — app/shop/sell/page.tsx
...
- `app/shop/sell/page.tsx` — 223 lines — score 138 — primary path, path keyword: shop
...
### Repo Evidence
Matched focused repo evidence: 12 files, about 1,700 readable source lines.
...
- `app/marketplace/sell/page.tsx` — 294 lines — score 134 — primary path, path keyword: marketplace
...
- `components/marketplace/dream.MarketplaceRequestButton.tsx` — 136 lines — score 130 — primary path, path keyword: marketplace
...
### Repo Evidence
Matched focused repo evidence: 11 files, about 1,527 readable source lines.
...
- useEffect — app/ads/create/page.tsx
...
- `app/ads/create/page.tsx` — 223 lines — score 130 — primary path, path keyword: ads
...
### Repo Evidence
Matched focused repo evidence: 58 files, about 16,958 readable source lines.
...
- `dreamdmbar/runtime/DreamSystemContext.tsx` — 453 lines — score 160 — primary path, path keyword: dreamdmbar
- `dreamdmbar/runtime/barInteractions.ts` — 533 lines — score 156 — primary path, path keyword: dreamdmbar
- `dreamdmbar/runtime/bridgeSeamFlow.ts` — 214 lines — score 152 — primary path, path keyword: dreamdmbar
- `dreamdmbar/dreamsurface.dreamdmbar.tsx` — 3098 lines — score 146 — primary path, path keyword: dreamdmbar
...
- `app/dreamdmbar/_components/HomeDreamRegion.tsx` — 461 lines — score 134 — primary path, path keyword: dreamdmbar
- `components/runtime/dream.DualRuntimeContainer.tsx` — 272 lines — score 134 — primary path, path keyword: runtime
...
- `components/runtime/dream.shell.RuntimeShell.tsx` — 352 lines — score 130 — primary path, path keyword: runtime
...
- `dreamdmbar/notifications/useNotifications.ts` — 194 lines — score 130 — primary path, path keyword: dreamdmbar
...
- `app/dreamdmbar/_components/DreamSpaceRegion.tsx` — 465 lines — score 126 — primary path, path keyword: dreamdmbar
...
- `dreamdmbar/dream.GlowingLight.tsx` — 103 lines — score 126 — primary path, path keyword: dreamdmbar
- `app/dreamdmbar/_components/dreamr/dream.DreamRCore.tsx` — 55 lines — score 126 — primary path, path keyword: dreamdmbar
- `dreamdmbar/hooks/useDreamDMDraft.ts` — 196 lines — score 122 — primary path, path keyword: dreamdmbar
- `dreamdmbar/hooks/useDreamDMMessages.ts` — 166 lines — score 122 — primary path, path keyword: dreamdmbar
- `dreamdmbar/hooks/useDreamDMConversations.ts` — 131 lines — score 122 — primary path, path keyword: dreamdmbar
...
- `engine/runtime/dualRuntimeBridge.ts` — 916 lines — score 81 — supporting path, path keyword: runtime
...
- `components/home/dream.ActiveModuleSurface.tsx` — 479 lines — score 59 — supporting path
## 13. Messaging
...
### Repo Evidence
Matched focused repo evidence: 22 files, about 4,216 readable source lines.
...
- `dreamdmbar/hooks/useDreamDMDraft.ts` — 196 lines — score 112 — primary path
...
- `dreamdmbar/hooks/useDreamDMMessages.ts` — 166 lines — score 108 — primary path
...
- `dreamdmbar/notifications/useNotifications.ts` — 194 lines — score 104 — primary path
- `dreamdmbar/hooks/useMessagingCore.ts` — 189 lines — score 104 — primary path
- `dreamdmbar/hooks/useDreamDMConversations.ts` — 131 lines — score 104 — primary path
...
- `components/dream.MessagesClient.tsx` — 887 lines — score 67 — supporting path
...
### Repo Evidence
Matched focused repo evidence: 18 files, about 4,570 readable source lines.
...
- `components/home/dream.ActiveModuleSurface.tsx` — 479 lines — score 126 — primary path, path keyword: home dream
...
- `app/dreamdmbar/_components/HomeDreamRegion.tsx` — 461 lines — score 112 — primary path
- `app/api/home-layout/route.ts` — 109 lines — score 67 — supporting path
- `components/dream.HomeFeed.tsx` — 1378 lines — score 59 — supporting path
- `components/dream.FeedCard.tsx` — 474 lines — score 55 — supporting path
...
### Repo Evidence
Matched focused repo evidence: 62 files, about 19,213 readable source lines.
...
- `app/dreamdmbar/_components/DreamSpaceRegion.tsx` — 465 lines — score 108 — primary path
...
- `components/runtime/dream.shell.RuntimeShell.tsx` — 352 lines — score 59 — supporting path
- `components/runtime/dream.DualRuntimeContainer.tsx` — 272 lines — score 59 — supporting path
...
### Repo Evidence
Matched focused repo evidence: 52 files, about 8,309 readable source lines.
...
- `components/dream.FeedCard.tsx` — 474 lines — score 59 — supporting path
...
### Repo Evidence
Matched focused repo evidence: 45 files, about 7,153 readable source lines.
...
- `components/runtime/dream.DualRuntimeContainer.tsx` — 272 lines — score 108 — primary path
- `components/home/dream.ActiveModuleSurface.tsx` — 479 lines — score 104 — primary path
...
### Repo Evidence
Matched focused repo evidence: 52 files, about 16,268 readable source lines.
...
- `components/profile/dream.ProfileCanvas.tsx` — 348 lines — score 130 — primary path, path keyword: profile
...
- `styles/globals.css` — 5174 lines — score 112 — primary path
- `engins/engin.BrandingEngin.tsx` — 1260 lines — score 112 — primary path
- `app/edit-profiledream/page.tsx` — 603 lines — score 112 — primary path
...
- `app/settings/privacy/dream.PrivacyClient.tsx` — 406 lines — score 104 — primary path
...
- `components/providers/dream.ThemeProvider.tsx` — 91 lines — score 104 — primary path
- `styles/home-dream.css` — 235 lines — score 100 — primary path
- `app/settings/controls/dream.ControlsClient.tsx` — 165 lines — score 100 — primary path
