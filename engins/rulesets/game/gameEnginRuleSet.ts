...
export const GAME_IMPLICIT_WORLD_POLICY = {
  ...
  namedGenerators: ['generateCaveChunk','generateRockProp','generateTerrainCutout','generateDestructibleWallChunk'],
  sharedKernel: 'engins/isosurfaceDualContouring.ts',
  output: 'terrain, caves, destructible walls, collision proxies, and procedural props use validated indexed SDF meshes',
} as const;
