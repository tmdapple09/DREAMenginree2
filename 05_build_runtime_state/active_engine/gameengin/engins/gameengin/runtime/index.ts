export { GAMEENGIN_FRAME_BUDGETS, resolveFrameBudget } from './FrameBudget';
export type { GameEnginFrameBudget, GameEnginQualityTier } from './FrameBudget';
export { GameEnginFrameClock } from './FrameClock';
