...
import type { DomainAuthorizationContext, DomainCapability } from '@/engine/engin-runtime/EnginCapabilities';
import type { InformationDomain, IntentEnvelope } from '@/engine/runtime/dreamOSBus';
