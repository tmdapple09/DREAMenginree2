...
- **Total files:** 2184
- **Total function/class nodes:** 4212
- **Total edges:** 8067
- **Orphan nodes:** 3707
...
graph LR
  ...
  src["src"] -->|315| components["components"]
...
<details><summary>engins/ (327 files)</summary>

| File | Type | Imports | Imported By | Top Importers | Top Imports |
|---|---|---|---|---|---|
| `engins/contentengin/assetTypes.ts` | ts | 0 | 37 | `components/contentengin/AssetPreview3D.tsx`, `engine/generated/engins.ts`, `engins/contentengin/builders/geometryBuilder.ts` | — |
| `engins/forgeengin/forge/forgeRegistry.ts` | ts | 0 | 23 | `app/daydream/forge/page.tsx`, `components/dreams/dreamsurface.dreamspace.tsx`, `components/forge/dream.panel.AIBuilderPanel.tsx` | — |
...
| `engins/engin.GameEngin.tsx` | tsx | 38 | 8 | `app/daydream/games/page.tsx`, `components/daydream/dream.StandaloneEnginSurface.tsx`, `components/engines/games/dream.GameEnginApp.tsx` | `components/daydream/dream.JourneyTrail.tsx`, `components/gameengin/dream.CartridgeRegistryBootstrap.tsx`, `components/gameengin/dream.cartridge.FeaturedCartridges.tsx` |
...
| `engins/forgeengin/forge/forgeMomentum.ts` | ts | 1 | 7 | `components/dreams/dreamsurface.dreamspace.tsx`, `components/forge/dream.widget.ForgeMomentumWidget.tsx`, `components/home/dream.FlagshipEnginesStrip.tsx` | `engins/forgeengin/forge/forgeRegistry.ts` |
...
| `engins/rulesets/game/gameEnginRuleSet.ts` | ts | 4 | 7 | `engine/generated/engins.ts`, `engins/engin.GameEngin.tsx`, `engins/rulesets/game/index.ts` | `engine/engin-runtime/EnginBaseState.ts`, `engine/engin-runtime/EnginCapabilities.ts`, `engine/engin-runtime/EnginCapabilityTargets.ts` |
...
| `engins/gameengin/core.ts` | ts | 2 | 6 | `engine/generated/engins.ts`, `engins/gameengin/GameEnginCore.ts`, `engins/gameengin/index.ts` | `engins/gameengin/power-systems.ts`, `engine/rendering/babylon/createEngine.ts` |
...
| `engins/codeengin/runner.ts` | ts | 2 | 5 | `app/api/ci/run/route.ts`, `app/api/codeengin/run/route.ts`, `app/api/codeengin/workspace/route.ts` | `engins/codeengin/workspaceStore.ts`, `engins/codeengin/types.ts` |
...
| `engins/gameengin/gameEnginRuntime.ts` | ts | 3 | 5 | `engine/generated/engins.ts`, `engine/os/index.ts`, `engins/gameengin/GameEnginCore.ts` | `engine/events/eventBus.ts`, `engins/gameengin/runtime/FrameBudget.ts`, `engins/gameengin/runtime/RuntimeQuality.ts` |
...
| `engins/contentengin/assets/indexedDBStore.ts` | ts | 0 | 4 | `engine/generated/engins.ts`, `engins/contentengin/assets/assetOptimizer.ts`, `src/engin/generated/engins.ts` | — |
...
| `engins/contentengin/pipeline/paths.ts` | ts | 0 | 4 | `app/api/contentengin/assets/[assetId]/export/gameengin/route.ts`, `app/api/contentengin/assets/[assetId]/route.ts`, `engine/generated/engins.ts` | — |
...
| `engins/forgeengin/enginpipe/telemetry/client.ts` | ts | 1 | 4 | `engine/generated/engins.ts`, `engins/forgeengin/enginpipe/index.ts`, `src/engin/generated/engins.ts` | `engins/forgeengin/enginpipe/telemetry/events.ts` |
...
| `engins/contentengin/builders/meshBuilder.ts` | ts | 2 | 3 | `engine/generated/engins.ts`, `engins/contentengin/pipeline/validate.ts`, `src/engin/generated/engins.ts` | `engins/isosurfaceDualContouring.ts`, `engins/contentengin/assetTypes.ts` |
| `engins/contentengin/builders/primitiveBuilder.ts` | ts | 1 | 3 | `engine/generated/engins.ts`, `engins/contentengin/builders/geometryBuilder.ts`, `src/engin/generated/engins.ts` | `engins/contentengin/assetTypes.ts` |
...
| `engins/contentengin/pipeline/exportGlb.ts` | ts | 2 | 3 | `engine/generated/engins.ts`, `engins/contentengin/pipeline/validate.ts`, `src/engin/generated/engins.ts` | `engins/contentengin/assetTypes.ts`, `engins/contentengin/builders/geometryBuilder.ts` |
...
| `engins/gameengin/index.ts` | ts | 15 | 3 | `components/games/dream.NeonDrift.tsx`, `engine/generated/engins.ts`, `src/engin/generated/engins.ts` | `engins/gameengin/controls/control-mappings.ts`, `engins/gameengin/core.ts`, `engins/gameengin/dream-engine.ts` |
...
| `engins/gameengin/procgen.ts` | ts | 1 | 3 | `engine/generated/engins.ts`, `engins/gameengin/executionWiring.ts`, `src/engin/generated/engins.ts` | `engins/isosurfaceDualContouring.ts` |
...
| `engins/gameengin/world-crdt.ts` | ts | 0 | 3 | `engine/generated/engins.ts`, `engins/gameengin/executionWiring.ts`, `src/engin/generated/engins.ts` | — |
...
| `engins/isosurfaceAssetPipeline.ts` | ts | 2 | 3 | `engins/contentengin/AssetViewport.tsx`, `engins/contentengin/useImplicitAssetWorkspace.ts`, `src/engin/generated/engins.ts` | `engins/isosurfaceDualContouring.ts`, `engins/contentengin/assetTypes.ts` |
...
| `engins/contentengin/ImplicitAssetWorkspace.tsx` | tsx | 2 | 2 | `components/contentengin/ContentEnginStudio.tsx`, `src/engin/generated/engins.ts` | `engins/contentengin/AssetViewport.tsx`, `engins/contentengin/useImplicitAssetWorkspace.ts` |
...
| `engins/contentengin/photo/imageAnalyzer.ts` | ts | 3 | 2 | `engine/generated/engins.ts`, `src/engin/generated/engins.ts` | `engins/contentengin/assetTypes.ts`, `engins/contentengin/materials/paletteExtractor.ts`, `engins/contentengin/photo/pngDecoder.ts` |
| `engins/contentengin/photo/photoToRecipe.ts` | ts | 1 | 2 | `engine/generated/engins.ts`, `src/engin/generated/engins.ts` | `engins/contentengin/assetTypes.ts` |
| `engins/contentengin/photo/regionDetector.ts` | ts | 1 | 2 | `engine/generated/engins.ts`, `src/engin/generated/engins.ts` | `engins/contentengin/assetTypes.ts` |
| `engins/contentengin/pipeline/build.ts` | ts | 1 | 2 | `engine/generated/engins.ts`, `src/engin/generated/engins.ts` | `engins/contentengin/assetTypes.ts` |
...
| `engins/contentengin/pipeline/validate.ts` | ts | 3 | 2 | `engine/generated/engins.ts`, `src/engin/generated/engins.ts` | `engins/contentengin/assetTypes.ts`, `engins/contentengin/builders/meshBuilder.ts`, `engins/contentengin/pipeline/exportGlb.ts` |
...
| `engins/contentengin/rigging/index.ts` | ts | 2 | 2 | `engine/generated/engins.ts`, `src/engin/generated/engins.ts` | `engins/contentengin/rigging/fitArmature.ts`, `engins/contentengin/rigging/rigTypes.ts` |
...
| `engins/contentengin/rigging/rigValidator.ts` | ts | 1 | 2 | `engine/generated/engins.ts`, `src/engin/generated/engins.ts` | `engins/contentengin/assetTypes.ts` |
...
| `engins/contentengin/useImplicitAssetWorkspace.ts` | ts | 3 | 2 | `engins/contentengin/ImplicitAssetWorkspace.tsx`, `src/engin/generated/engins.ts` | `engins/rulesets/content/useContentEnginRuntime.ts`, `engins/isosurfaceAssetPipeline.ts`, `engins/isosurfaceDualContouring.ts` |
...
| `components/runtime/dream.DualRuntimeContainer.tsx` | tsx | 2 | 9 | `app/dreamdmbar/_components/DreamBarDataBridge.tsx`, `app/dreamdmbar/dreamspace/page.tsx`, `app/dreamdmbar/homedream/page.tsx` | `engine/runtime/dualRuntime.ts`, `engine/runtime/iEngine.ts` |
...
| `components/ui-system/runtimeViewport.ts` | ts | 1 | 7 | `app/dreamdmbar/_components/HomeDreamRegion.tsx`, `components/dream.HomeFeed.tsx`, `components/runtime/dream.shell.RuntimeShell.tsx` | `components/ui-system/responsive.ts` |
...
| `components/dream.CommandPalette.tsx` | tsx | 0 | 4 | `app/layout.tsx`, `components/providers/dream.AppSurfaceShell.tsx`, `engine/generated/surfaces.ts` | — |
...
| `components/games/dream.NeonDrift.tsx` | tsx | 7 | 4 | `components/games/dream.GamesHub.tsx`, `engine/generated/surfaces.ts`, `engins/gameengin/cartridges/loaders.ts` | `components/gameengin/input/DualSenseManager.ts`, `engins/gameengin/index.ts`, `engins/gameengin/ai-director.ts` |
...
| `components/music/dream.SoundRecorder.tsx` | tsx | 1 | 4 | `app/daydream/music/page.tsx`, `daydreams/music/page.tsx`, `engine/generated/surfaces.ts` | `utils/index.ts` |
...
| `components/dream.HomeFeed.tsx` | tsx | 12 | 3 | `app/dreamdmbar/_components/HomeDreamRegion.tsx`, `engine/generated/surfaces.ts`, `src/engin/generated/surfaces.ts` | `components/ads/dream.AdUnit.tsx`, `components/feed/dream.FeedVideoCard.tsx`, `components/profile/dream.EditableAvatar.tsx` |
...
| `components/dream.MessagesClient.tsx` | tsx | 6 | 3 | `app/messages/page.tsx`, `engine/generated/surfaces.ts`, `src/engin/generated/surfaces.ts` | `dreamdmbar/hooks/useDreamDMDraft.ts`, `dreamdmbar/hooks/useDreamDMMessages.ts`, `dreamdmbar/hooks/useDreamSearch.ts` |
...
| `components/home/dream.FlagshipEnginesStrip.tsx` | tsx | 2 | 3 | `app/dreamdmbar/_components/HomeDreamRegion.tsx`, `engine/generated/surfaces.ts`, `src/engin/generated/surfaces.ts` | `engins/forgeengin/forge/forgeMomentum.ts`, `engins/forgeengin/forge/forgeRegistry.ts` |
...
| `components/marketplace/dream.MarketplaceRequestButton.tsx` | tsx | 1 | 3 | `app/marketplace/[id]/page.tsx`, `engine/generated/surfaces.ts`, `src/engin/generated/surfaces.ts` | `utils/index.ts` |
...
| `components/panels/dream.panel.WidgetsPanel.tsx` | tsx | 4 | 3 | `components/runtime/dream.RuntimeView.tsx`, `engine/generated/surfaces.ts`, `src/engin/generated/surfaces.ts` | `components/ui/dream.DreamWord.tsx`, `dreamdmbar/runtime/DreamSystemContext.tsx`, `supabase/client/client.ts` |
...
| `components/runtime/dream.RuntimeView.tsx` | tsx | 30 | 3 | `components/home/dream.bar.PersistentDreamBar.tsx`, `engine/generated/surfaces.ts`, `src/engin/generated/surfaces.ts` | `app/dreamdmbar/_components/HomeDreamRegion.tsx`, `components/dreams/dreamsurface.dreamspace.tsx`, `components/runtime/dream.shell.RuntimeShell.tsx` |
| `components/runtime/dream.shell.RuntimeShell.tsx` | tsx | 1 | 3 | `components/runtime/dream.RuntimeView.tsx`, `engine/generated/surfaces.ts`, `src/engin/generated/surfaces.ts` | `components/ui-system/runtimeViewport.ts` |
...
| `components/profile/dream.ProfileCanvas.tsx` | tsx | 4 | 2 | `engine/generated/surfaces.ts`, `src/engin/generated/surfaces.ts` | `components/ui/dream.PlatformBadge.tsx`, `engine/social/platforms.ts`, `supabase/client/client.ts` |
...
| `app/dreamdmbar/_components/HomeDreamRegion.tsx` | tsx | 11 | 5 | `app/homedream/page.tsx`, `components/core/dream.CoreDream.tsx`, `components/runtime/dream.RuntimeView.tsx` | `app/dreamdmbar/_components/dreamr/dreamsurface.dreamr.tsx`, `components/dream.BrandLogo.tsx`, `components/dream.HomeFeed.tsx` |
...
| `app/feed-settings/dream.FeedSettingsClient.tsx` | tsx | 0 | 3 | `app/feed-settings/page.tsx`, `engine/generated/surfaces.ts`, `src/engin/generated/surfaces.ts` | — |
...
| `app/settings/controls/dream.ControlsClient.tsx` | tsx | 1 | 3 | `app/settings/controls/page.tsx`, `engine/generated/surfaces.ts`, `src/engin/generated/surfaces.ts` | `app/settings/controls/dream.PositionIndicatorToggle.tsx` |
...
| `app/settings/privacy/dream.PrivacyClient.tsx` | tsx | 0 | 3 | `app/settings/privacy/page.tsx`, `engine/generated/surfaces.ts`, `src/engin/generated/surfaces.ts` | — |
...
| `app/ads/create/page.tsx` | route | 3 | 2 | `engine/generated/surfaces.ts`, `src/engin/generated/surfaces.ts` | `supabase/client/client.ts`, `supabase/client/safeGetUser.ts`, `utils/index.ts` |
...
| `app/api/connectors/[provider]/items/route.ts` | route | 3 | 2 | `engine/generated/surfaces.ts`, `src/engin/generated/surfaces.ts` | `supabase/server/serverClient.ts`, `supabase/client/safeGetUser.ts`, `utils/index.ts` |
...
| `app/api/youtube/live-feed/route.ts` | route | 3 | 2 | `engine/generated/surfaces.ts`, `src/engin/generated/surfaces.ts` | `engine/connectors/providers/youtube.ts`, `types/connector.ts`, `utils/index.ts` |
...
| `app/edit-profiledream/page.tsx` | route | 5 | 2 | `engine/generated/surfaces.ts`, `src/engin/generated/surfaces.ts` | `components/activity/dream.ActivityProfile.tsx`, `components/profile/dream.widget.ProfileWidgetGrid.tsx`, `components/ui/dream.DreamWord.tsx` |
...
| `app/engines/page.tsx` | route | 3 | 2 | `engine/generated/surfaces.ts`, `src/engin/generated/surfaces.ts` | `engine/dev-bypass.ts`, `supabase/server/serverClient.ts`, `supabase/client/safeGetUser.ts` |
...
| `app/layout.tsx` | route | 14 | 2 | `engine/generated/surfaces.ts`, `src/engin/generated/surfaces.ts` | `components/dream.CommandPalette.tsx`, `components/dream.GlobalOverlays.tsx`, `components/dream.ThemeApplicator.tsx` |
...
| `app/marketplace/sell/page.tsx` | route | 3 | 2 | `engine/generated/surfaces.ts`, `src/engin/generated/surfaces.ts` | `supabase/client/client.ts`, `supabase/client/safeGetUser.ts`, `utils/index.ts` |
...
| `app/shop/sell/page.tsx` | route | 3 | 2 | `engine/generated/surfaces.ts`, `src/engin/generated/surfaces.ts` | `supabase/client/client.ts`, `supabase/client/safeGetUser.ts`, `utils/index.ts` |
...
| File | Type | Imports | Imported By | Top Importers | Top Imports |
|---|---|---|---|---|---|
| `dreamdmbar/runtime/DreamSystemContext.tsx` | tsx | 5 | 28 | `app/dreamdmbar/_components/DreamBarDataBridge.tsx`, `app/dreamdmbar/dreamspace/page.tsx`, `app/dreamdmbar/dualruntime/page.tsx` | `dreamdmbar/runtime/barInteractions.ts`, `components/panels/panelTypes.ts`, `engine/runtime/dualRuntime.ts` |
...
| `dreamdmbar/notifications/notificationHelpers.ts` | ts | 0 | 6 | `components/dream.NotificationCenter.tsx`, `dreamdmbar/notifications/useNotifications.ts`, `engine/generated/dreamdmbar.ts` | — |
...
| `dreamdmbar/hooks/useDreamDMMessages.ts` | ts | 2 | 5 | `components/dream.MessagesClient.tsx`, `dreamdmbar/dreamsurface.dreamdmbar.tsx`, `dreamdmbar/hooks/useMessagingCore.ts` | `engine/io.ts`, `supabase/client/client.ts` |
| `dreamdmbar/hooks/useDreamDMDraft.ts` | ts | 0 | 4 | `components/dream.MessagesClient.tsx`, `dreamdmbar/dreamsurface.dreamdmbar.tsx`, `engine/generated/dreamdmbar.ts` | — |
...
| `dreamdmbar/notifications/useNotifications.ts` | ts | 2 | 4 | `app/dreamdmbar/_components/HomeDreamRegion.tsx`, `components/dream.NotificationCenter.tsx`, `engine/generated/dreamdmbar.ts` | `dreamdmbar/notifications/notificationHelpers.ts`, `utils/index.ts` |
...
| `dreamdmbar/dreamsurface.dreamdmbar.tsx` | tsx | 16 | 3 | `components/home/dream.bar.PersistentDreamBar.tsx`, `engine/generated/dreamdmbar.ts`, `src/engin/generated/dreamdmbar.ts` | `components/ui/dream.DreamWord.tsx`, `dreamdmbar/dream.GlowingLight.tsx`, `dreamdmbar/runtime/barInteractions.ts` |
| `dreamdmbar/hooks/useDreamDMConversations.ts` | ts | 2 | 3 | `dreamdmbar/dreamsurface.dreamdmbar.tsx`, `engine/generated/dreamdmbar.ts`, `src/engin/generated/dreamdmbar.ts` | `engine/io.ts`, `supabase/client/client.ts` |
...
| `dreamdmbar/hooks/useNotifications.ts` | ts | 0 | 3 | `dreamdmbar/dreamsurface.dreamdmbar.tsx`, `engine/generated/dreamdmbar.ts`, `src/engin/generated/dreamdmbar.ts` | — |
...
| `src/engin/generated/engins.ts` | ts | 236 | 1 | `src/engin/generated/index.ts` | `engins/autoopen/dream.AutoOpenGameEngin.tsx`, `engins/brandingengin/identity/logos.ts`, `engins/codeengin/ai/drEamsCodeAssist.ts` |
...
| `src/engin/generated/surfaces.ts` | ts | 575 | 1 | `src/engin/generated/index.ts` | `app/(internal)/idari-console/page.tsx`, `app/(internal)/idari-console/platform-errors/page.tsx`, `app/(internal)/idari-console/platform-health/page.tsx` |
...
| `hooks/useDreamLayout.ts` | ts | 0 | 4 | `app/settings/dreams/dreams-layout-editor.tsx`, `components/home/dream.bar.PersistentDreamBar.tsx`, `engine/generated/hooks.ts` | — |
...
| `hooks/useConnectorInstallFlow.ts` | ts | 3 | 3 | `app/connectors/dream.ConnectorsClient.tsx`, `engine/generated/hooks.ts`, `src/engin/generated/hooks.ts` | `engine/connectors/connectorRegistry.ts`, `engine/connectors/installFlow.ts`, `engine/widgets/widgetRegistry.ts` |
...
| `hooks/useResponsive.ts` | ts | 0 | 2 | `engine/generated/hooks.ts`, `src/engin/generated/hooks.ts` | — |
...
| `DREAMenginree2-contentengin-webgpu-patched-no-media.zip` | file |
