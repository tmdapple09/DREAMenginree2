...
export const metadata = {
  ...
  description: "Code projects, snippets, files, and deployments.",
};
...
const WIDGETS: DaydreamWidget[] = [
  {
    id: "ide",
    emoji: "💻",
    label: "Open CodeEngin",
    desc: "Launch the full IDE + preview",
    color: "#6366f1",
    href: "/engines/code",
  },
  {
    ...
    emoji: "📁",
    label: "Projects",
    desc: "Browse your code projects",
    color: "#2a8ab8",
    href: "/engines/code/projects",
  },
  {
    id: "drafts",
    emoji: "✍️",
    label: "Drafts",
    desc: "Continue unfinished code ideas",
    color: "#a855f7",
    href: "/engines/code?view=drafts",
  },
  {
    id: "notebook",
    emoji: "📓",
    label: "Notebook",
    desc: "Run multi-cell notes",
    color: "#22c55e",
    href: "/engines/code/notebook",
  },
  {
    id: "lab",
    emoji: "🔬",
    label: "Lab",
    desc: "Experiments and prototypes",
    color: "#f59e0b",
    href: "/daydream/lab",
  },
  {
  ...
  },
  {
    ...
    emoji: "🔌",
    label: "Connectors",
    desc: "Link GitHub, GitLab, and more",
    color: "#8b5cf6",
    href: "/connectors",
  },
];
        ...
        <div className="de-auth-content space-y-4">
            ...
            <div style={{ position: "relative", zIndex: 1 }}>
              <div
                style={{
                  ...
                  borderRadius: 9999,
                  background:
                    "linear-gradient(135deg, rgba(34,211,238,0.12) 0%, rgba(59,130,246,0.12) 100%)",
                  border: "1px solid rgba(34,211,238,0.25)",
                }}
              >
                <span
                  style={{ fontSize: 11, fontWeight: 700, color: "#22d3ee" }}
                >
                  Code 2026 · Monaco IDE · AI Copilot · Multi-Cursor
                </span>
              </div>
              <h2
                style={{
              ...
              >
                Browse and manage your saved projects, files, and zip folders
                here on Side A. Pick what you want to work on, then flip to{" "}
                <strong>CodeEngin (Side B)</strong> to write, run, and preview
                it as a web app, game, or song.
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div className="de-widget-body" style={{ paddingTop: 12 }}>
              ...
              >
                Your saved code projects live here. Click any project to open it
                in CodeEngin for editing, running, and previewing.
              </div>
              {/* Example saved projects — these load from CodeEngin on Side B */}
              {[
                {
                  emoji: "🎮",
                  name: "game-engine-mod",
                  lang: "TypeScript",
                  updated: "Today",
                  preview: "game",
                },
                ...
                <Link
                  key={p.name}
                  href={`/engines/code?project=${p.name}`}
          ...
          <div className="de-widget">
            ...
            <div className="de-widget-body" style={{ paddingTop: 10 }}>
              ...
              >
                Upload zip archives or individual source files here. CodeEngin
                unpacks them and makes them available for editing in the full
                IDE on Side B.
              </div>
                ...
                {[
                  {
                    emoji: "🗜️",
                    label: "Upload .zip",
                    href: "/engines/code?import=zip",
                  },
                  {
                    emoji: "📄",
                    label: "Upload file",
                    href: "/engines/code?import=file",
                  },
                  {
                    emoji: "🔗",
                    label: "Clone from Git",
                    href: "/engines/code?import=git",
                  },
                ].map((opt) => (
                  <Link
                    key={opt.label}
          ...
          <div className="de-widget">
            ...
            <div className="de-widget-body">
              ...
              >
                CodeEngin can render your code as different output types. Choose
                a project above and select the preview mode in Side B.
              </div>
              <div
                style={{
                  display: "grid",
                ...
                {[
                  {
                    emoji: "🌐",
                    label: "Web App",
                    desc: "Interactive preview",
                    color: "#6366f1",
                    href: "/engines/code?preview=webapp",
                  },
                  {
                    emoji: "🎮",
                    label: "Game",
                    desc: "Babylon.js / WebGPU output",
                    color: "#c8981a",
                    href: "/engines/code?preview=game",
                  },
                  {
                    emoji: "🎵",
                    label: "Music",
                    desc: "Audio + waveform render",
                    color: "#8b5cf6",
                    href: "/engines/code?preview=music",
                  },
                  {
                    emoji: "📊",
                    label: "Data / Chart",
                    desc: "D3 / canvas output",
                    color: "#0ea5e9",
                    href: "/engines/code?preview=data",
                  },
                ].map((t) => (
                  <Link
                    key={t.label}
          ...
          <div className="de-widget">
            ...
            <div className="de-widget-body">
              ...
              >
                AI-powered code suggestions, refactoring, bug detection, and
                documentation generation — all from inside the notebook in
                CodeEngin.
              </p>
          ...
          <div className="de-widget">
            ...
            <div className="de-widget-body">
              ...
              >
                Real-time collaborative coding — invite a co-author by handle.
                Edits appear live with a colored cursor.
              </p>
          ...
          {/* ── Feature 16: Interactive Notebook ── */}
          <div className="de-widget">
            <div className="de-widget-header">
              <span className="de-widget-title">📓 Interactive Notebook</span>
              <Link
                href="/engines/code/notebook"
                className="text-xs font-semibold ml-auto"
                style={{ color: "#6366f1" }}
            ...
            <div className="de-widget-body">
              <p style={{ fontSize: 12, color: "var(--de-text-dim)" }}>
                Multi-cell code notebook with JavaScript & TypeScript support.
                Run cells in-browser, save state to Supabase, and get AI
                suggestions inline.
              </p>
            </div>
          </div>
                ...
                {[
                  ...
                  <div
                    ...
                    style={{
                      ...
                      padding: "7px 5px",
                      borderRadius: 8,
                      background: e.on ? `${e.color}0e` : "rgba(0,0,0,0.04)",
                      border: `1px solid ${e.on ? e.color + "25" : "rgba(0,0,0,0.06)"}`,
                    }}
                  >
                    <div
                      style={{
                        fontSize: 8,
                        fontWeight: 700,
                        color: e.on ? e.color : "var(--de-text-dim)",
                      }}
                    >
                      {e.name.replace("Engin", "")}
                    </div>
                    <div
                      style={{
                        fontSize: 8,
          ...
          <div className="de-widget">
            ...
            <div className="de-widget-body">
              ...
              >
                Every AI code suggestion goes through the Trust Layer — you
                review, accept, or reject changes before they commit. Zero blind
                writes to your codebase.
              </p>
          ...
          <div className="de-widget">
            ...
            <div className="de-widget-body">
              ...
              >
                ...
                <span style={{ color: "#fbbf24" }}>createEntity</span>();
              </div>
              <p
                style={{
                  fontSize: 11,
              ...
              >
                Import ECS APIs, post-FX managers, and AI Director directly into
                your code notebooks.
              </p>
            </div>
          </div>
          ...
          <div className="de-widget">
            ...
            <div className="de-widget-body">
              ...
              >
                {[
                  {
                    label: "Project Dream Window",
                    href: "/engines/code/projects",
                  },
                  {
                    label: "Code File Dream Window",
                    href: "/engines/code?view=files",
                  },
                  {
                    label: "Snippet Dream Window",
                    href: "/engines/code?view=snippets",
                  },
                  {
                    label: "Terminal Dream Window",
                    href: "/engines/code?panel=terminal",
                  },
                  {
                    label: "Publish Dream Window",
                    href: "/engines/code?panel=deploy",
                  },
                  { label: "Dream Window", href: "/engines/code?panel=window" },
                ].map((item) => (
                  <Link
                    key={item.label}
                    href={item.href}
          ...
          >
            ...
            >
              CodeEngin — 20 Features on Side B
            </div>
            <p
              style={{
                fontSize: 11,
            ...
            >
              Notebook · Projects · GitHub · AI Assist · Trust Layer · Pair
              Programming · API Workspace · Snippet Library · Diff Viewer · Game
              Engine Integration + more.
            </p>
          </div>
        </div>
      </div>
